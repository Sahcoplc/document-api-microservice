...
const documentApproval = ({ title, name, documentType, department, senderName }) => 
`<!DOCTYPE html>
                                                                                            ...
                                                                                            <tr
                                                                                                ...
                                                                                                <td style="padding:10px;line-height:36px;text-align:inherit;font-family:'Poppins',sans-serif;background-color:rgb(235,239,244)"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <p
                                                                                                            style="font-size:15px;font-family:'Poppins',sans-serif;color:rgb(30,35,41)">
                                                                                                            ${senderName} from ${department} has ${status} your ${documentType} document. Log in to SAHCO Internals to view document. 
                                                                                                        </p>
